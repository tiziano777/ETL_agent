...
def create_pipeline(llm_node: SchemaNode,
                    ...
                    validation_node: ValidationNode) -> StateGraph:
    ...
    graph.add_edge("human_node", "llm_node")        # loop di feedback
    graph.add_edge("human_node", "validation_node")  # quando break
    graph.add_edge("validation_node", "llm_node")    # se validazione fallisce
    graph.add_edge("validation_node", END)           # se validazione ok
