...
def process_file(file_path: str, mapper_mapping: List, dst_schema: Dict[str, Any], output_path: str) -> Tuple[str, bool, int, Any]:
    mapper = Mapper()
    ...
    with ProcessPoolExecutor(max_workers=os.cpu_count()) as executor:
        ...
        for i, future in enumerate(as_completed(futures)):
            ...
            if success:
                ...
                print(f"Elaborazione del file {filename} fallita: {error}") # Usiamo print per la logica, la UI lo gestirà
        return {
